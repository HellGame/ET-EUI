...
namespace ET
{
    ...
    public class AccountCheckOutComponentAwakeSystem: AwakeSystem<AccountCheckOutTimeComponent, long>
    {
    ...
    public class AccountCheckOutComponentDestroySystem: DestroySystem<AccountCheckOutTimeComponent>
    {
